...
# 対象リポジトリ（bootstrap.sh が __OWNER__/__REPO__ を置換、または PROJECT_REPO で上書き）
REPO="${PROJECT_REPO:-__OWNER__/__REPO__}"
...
# 依存先の repo スコープ REST は可否が変動する経路で（07-14 許可 → 07-26 403 → 09-18 再び 200・#338 / #692）、
